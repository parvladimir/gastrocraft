...
export function createProposal(input: ProposalInput) {
  ...
  const subject = "Mehr als ein Google-Eintrag: eine Idee für " + name;
  const text = [
    "Guten Tag liebes Team von " + name + ",",
    "",
    "Ein Gast entdeckt Ihr Restaurant auf Google Maps. Was passiert als Nächstes? Er möchte die Speisekarte sehen, Öffnungszeiten prüfen und wissen, ob Ihr Angebot zu ihm passt – meist direkt auf dem Smartphone. Wenn diese Informationen verstreut oder veraltet sind, ist der nächste Suchtreffer nur einen Klick entfernt.",
    "",
    "Google Maps hilft Gästen, Sie zu finden. Eine eigene Website mit digitaler Speisekarte hilft ihnen, sich für Sie zu entscheiden. In einer Welt, in der die Restaurantsuche auf dem Handy beginnt, gehört ein guter digitaler Auftritt zur Grundausstattung – nicht mehr zum Luxus.",
    "",
    "Was Ihnen das konkret bringt:",
    "• Speisekarte, Preise und Öffnungszeiten an einem übersichtlichen Ort – auch mobil.",
    "• Ein erster Eindruck, der Ihre Küche, Ihr Ambiente und Ihre Besonderheiten zeigt.",
    "• Direkte Wege zu Anruf, Route oder Anfrage, ohne dass Gäste lange suchen müssen.",
    "",
    "So kann der Unterschied aussehen – ein Beispiel aus Dorsten-Wulfen:",
    ...
    "",
    "Wenn Ihnen die Idee gefällt, erstellen wir für " + name + " kostenlos und unverbindlich ein persönliches Website-Demo mit digitaler Speisekarte. Sie erhalten einen Link und können in Ruhe ansehen, wie Ihr eigener Auftritt aussehen könnte. Antworten Sie einfach mit „Demo“ – wir kümmern uns um den Rest.",
    "",
  ...
  const html = [
    ...
    '<div style="display:none;font-size:1px;line-height:1px;color:#f3f0e9;max-height:0;max-width:0;opacity:0;overflow:hidden">Google Maps hilft Gästen, Sie zu finden. Website und digitale Speisekarte helfen bei der Entscheidung. Persönliches Demo kostenlos.</div>',
    ...
    '<h1 style="margin:0;color:#fff;font-family:Georgia,serif;font-size:32px;font-weight:400;line-height:1.22">Gefunden werden ist gut.<br>Gewählt werden ist besser.</h1>',
    ...
    '<p style="margin:0 0 20px;font-size:16px;line-height:26px">Ein Gast entdeckt Ihr Restaurant auf Google Maps. Was passiert als Nächstes? Er möchte die Speisekarte sehen, Öffnungszeiten prüfen und wissen, ob Ihr Angebot zu ihm passt – meist direkt auf dem Smartphone. Wenn diese Informationen verstreut oder veraltet sind, ist der nächste Suchtreffer nur einen Klick entfernt.</p>',
    '<p style="margin:0 0 24px;font-size:16px;line-height:26px"><strong>Google Maps hilft Gästen, Sie zu finden. Eine eigene Website mit digitaler Speisekarte hilft ihnen, sich für Sie zu entscheiden.</strong> In einer Welt, in der die Restaurantsuche auf dem Handy beginnt, gehört ein guter digitaler Auftritt zur Grundausstattung – nicht mehr zum Luxus.</p>',
    '<p style="margin:0 0 11px;color:#9a6e31;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase">Was Ihnen das konkret bringt</p>',
    '<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;margin:0 0 28px">',
    '<tr><td valign="top" style="padding:9px 12px 9px 0;color:#b58642;font-size:18px;font-weight:700">01</td><td style="padding:9px 0;color:#1b2937;font-size:15px;line-height:23px"><strong>Alles an einem Ort:</strong> Speisekarte, Preise und Öffnungszeiten – klar und mobil lesbar.</td></tr>',
    '<tr><td valign="top" style="padding:9px 12px 9px 0;color:#b58642;font-size:18px;font-weight:700">02</td><td style="padding:9px 0;color:#1b2937;font-size:15px;line-height:23px"><strong>Ihr eigener Eindruck:</strong> Zeigen Sie Ihre Küche, Ihr Ambiente und was Sie besonders macht.</td></tr>',
    '<tr><td valign="top" style="padding:9px 12px 9px 0;color:#b58642;font-size:18px;font-weight:700">03</td><td style="padding:9px 0;color:#1b2937;font-size:15px;line-height:23px"><strong>Der direkte Weg:</strong> Anruf, Route oder Anfrage ohne langes Suchen.</td></tr>',
    '</table>',
    ...
    '<h2 style="margin:0 0 22px;color:#17283b;font-family:Georgia,serif;font-size:25px;font-weight:400;line-height:32px">Sehen Sie den Unterschied selbst.</h2>',
    ...
    '<h2 style="margin:0 0 12px;color:#fff;font-family:Georgia,serif;font-size:25px;font-weight:400;line-height:31px">Ihre Website. Ihre digitale Speisekarte. Ihr kostenloses Demo.</h2>',
    '<p style="margin:0 0 18px;color:#ecf0f3;font-size:15px;line-height:24px">Wenn Ihnen die Idee gefällt, gestalten wir für Ihr Restaurant unverbindlich eine persönliche Vorschau mit digitaler Speisekarte. Sie bekommen einen Link und können in Ruhe sehen, wie Ihr Auftritt aussehen könnte.</p>',
